...
//first you import the package (if the class is located in a different pacakge),
//then you can directly access to them via class instance.
...
//call constructors / methods to access them
...
//setter methods to change the value of the instance variables after when objects were made        
...
//if you set the value of the instance variable out of range (ex t.setSecond(60));
